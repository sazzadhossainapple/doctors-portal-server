...
async function run() {
  try {
    ...
    app.get("/appointmentOptions", async (req, res) => {
      ...
      const alreadyBooked = await bookingsCollection.find(bookQuery).toArray();
...
app.listen(port, () => {
  console.log(`doctors portal server in running port ${port}`);
});
